...
/**
 * Photo delete endpoint. Requires Authorization: Bearer <token>.
 *
 * POST /api/delete_user_beer_photo.php (multipart/form-data)
 * Fields: beer, brewery, filename
 * Response: {"status":"ok", "photos":string[]}
 */
